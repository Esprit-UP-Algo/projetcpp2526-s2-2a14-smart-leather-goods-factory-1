    ...
    , m_idEmploye(idEmploye)
{
    ...
    addNavBtn("Matières", [this]() { on_pushButton_23_clicked(); });
    addNavBtn("Machines", {}, true);
    ...
    QPushButton *logoutBtnSide = addNavBtn("Déconnexion", [this]() { on_pushButton_11_clicked(); });
    ...
    connect(chatBtn, &QPushButton::clicked, this, &pagemachine::on_chatButton_clicked);
}
...
void pagemachine::on_chatButton_clicked()
{
...
QString pagemachine::displayNameEmployeConnecte() const
{
    QSqlQuery q;
