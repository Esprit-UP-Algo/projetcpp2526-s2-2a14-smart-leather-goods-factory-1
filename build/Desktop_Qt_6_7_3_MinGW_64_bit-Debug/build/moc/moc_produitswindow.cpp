...
struct qt_meta_stringdata_CLASSproduitswindowENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSproduitswindowENDCLASS = QtMocHelpers::stringData(
    "produitswindow",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSproduitswindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject produitswindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSproduitswindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSproduitswindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSproduitswindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<produitswindow, std::true_type>,
...
void *produitswindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSproduitswindowENDCLASS.stringdata0))
