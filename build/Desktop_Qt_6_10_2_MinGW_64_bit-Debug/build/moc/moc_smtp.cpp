...
namespace {
struct qt_meta_tag_ZN4SmtpE_t {};
} // unnamed namespace

template <> constexpr inline auto Smtp::qt_create_metaobjectdata<qt_meta_tag_ZN4SmtpE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'stateChanged'
        QtMocHelpers::SlotData<void(QAbstractSocket::SocketState)>(3, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 4, 5 },
        }}),
        // Slot 'errorReceived'
    ...
    return QtMocHelpers::metaObjectData<Smtp, qt_meta_tag_ZN4SmtpE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Smtp::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4SmtpE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4SmtpE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN4SmtpE_t>.metaTypes,
    nullptr
} };
...
void Smtp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Smtp::*)(const QString & )>(_a, &Smtp::status, 0))
            return;
    }
}
...
void *Smtp::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4SmtpE_t>.strings))
