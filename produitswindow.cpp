...
void produitswindow::navToEmploye() {
    if (denyIfRoleMismatch(this, m_idEmployeConnecte, "Employe")) return;
    auto *p = new pageemployee(m_idEmployeConnecte, nullptr);
    p->show();
    this->close();
    this->deleteLater();
}
...
void produitswindow::navToCommandes() {
    ...
    auto *c = new commandes(m_idEmployeConnecte, nullptr);
    c->show();
    this->close();
    this->deleteLater();
}
...
void produitswindow::navToFournisseurs() {
    ...
    auto *f = new fournisseurs(m_idEmployeConnecte, nullptr);
    f->show();
    this->close();
    this->deleteLater();
}
...
void produitswindow::navToMatieres() {
    ...
    auto *m = new Matieres(m_idEmployeConnecte, nullptr);
    m->show();
    this->close();
    this->deleteLater();
}
...
void produitswindow::navToMachines() {
    ...
    auto *pm = new pagemachine(m_idEmployeConnecte, nullptr);
    pm->show();
    this->close();
    this->deleteLater();
}
